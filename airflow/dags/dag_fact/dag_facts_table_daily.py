...
with DAG(
    ...
    create_fact_total_per_state = PostgresOperator(
        ...
        sql = "/home/fajarsetia/Documents/final_project_de9/fact_table/fact_total_per_state.sql"
    )
    ...
    create_fact_daily_avg_currency = PostgresOperator(
        ...
        postgres_conn_id = "airflow_final_project",
        sql = "/home/fajarsetia/Documents/final_project_de9/fact_table/fact_daily_avg_currency.sql"
    )
